...
class Prowl
{
	...
	var $_api_key = null;
	var $_prov_key = null;
	var $_api_domain = 'https://prowl.weks.net/publicapi/';
	var $_url_verify = 'verify?apikey=%s&providerkey=%s';
	var $_url_push = 'add';
	...
	function Prowl($apikey=null, $verify=false, $provkey=null, $proxy=null, $userpwd=null)
	{
